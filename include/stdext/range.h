...
namespace stdext
{
    ...
    template <typename Range> using range_value_type_t = value_type_t<Range, is_range>;
    template <typename Range> using range_position_type = position_type<Range, is_range>;
    template <typename Range> using range_position_type_t = position_type_t<Range, is_range>;
    template <typename Range> using range_difference_type = difference_type<Range, is_range>;
    template <typename Range> using range_difference_type_t = difference_type_t<Range, is_range>;
    template <typename Range> using range_reference_type = reference_type<Range, is_range>;
    template <typename Range> using range_reference_type_t = reference_type_t<Range, is_range>;
    template <typename Range> using range_size_type = size_type<Range, is_range>;
    template <typename Range> using range_size_type_t = size_type_t<Range, is_range>;
    ...
    template <typename Elem, typename Range, STDEXT_REQUIRES(std::is_convertible<Elem, range_value_type_t<Range>>::value)>
    ...
    template <typename Elem, typename RangeProvider, STDEXT_REQUIRES(std::is_convertible<Elem, value_type_t<RangeProvider, is_stl_range_provider>>::value)>
