...
namespace stdext
{
    ...
    template <> memory_input_stream_base<const uint8_t*>::~memory_input_stream_base() = default;
    template <> memory_input_stream_base<uint8_t*>::~memory_input_stream_base() = default;
    memory_output_stream_base::~memory_output_stream_base() = default;
